...
function parseHMS.Core(source, roundCoordinates, errors) {
...
function parse(source, parameters, callback) {
    ...
    when(buildParseArgs(source), function(errorArray, dataArray) {
        ...
        result = parseHMS.Core(dataArray, parameters.precision >= 0 ? createCoordinatesRounder(parameters.precision) : eigen, errors);
