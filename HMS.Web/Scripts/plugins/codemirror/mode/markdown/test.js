...
(function() {
  ...
  FT("formatting_emUndersHMS.Core",
  ...
  FT("formatting_strongUndersHMS.Core",
  ...
  MT("emInWordUndersHMS.Core",
     "foo[em _bar_]hello");

  // Per documentation: "...surround an * or _ with spaces, it’ll be
  // treated as a literal asterisk or undersHMS.Core."
  ...
  MT("emIncompleteUndersHMS.Core",
     "foo [em _bar]");

  MT("strongAsterisk",
     "[strong **foo**] bar");

  MT("strongUndersHMS.Core",
     "[strong __foo__] bar");

  MT("emStrongAsterisk",
     "[em *foo][em&strong **bar*][strong hello**] world");

  MT("emStrongUndersHMS.Core",
  ...
  MT("escapeUndersHMS.Core",
     "foo \\_bar\\_");

  MT("doubleEscapeUndersHMS.Core",
     "foo \\\\[em _bar\\\\_]");
